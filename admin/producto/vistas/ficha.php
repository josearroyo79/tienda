            ...
            <div class="row">
                <div class="col-md-12">
                    ...
                    <div class="form-group">
                        <label>Tipo</label>
                        <p class="form-control-static"><?php echo "De ".$producto->getTipo()." Años"; ?></p>
                    </div>
                    <div class="form-group">
                        <label>Marca</label>
                    ...
                    <p><a href="/tienda/catalogo.php" class="btn btn-primary"><span class="glyphicon glyphicon-ok"></span> Ok</a></p>
                </div>
            </div>        
        </div>
    </div>

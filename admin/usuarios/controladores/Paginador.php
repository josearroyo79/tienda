...
class Paginador {
  ...
  public function crearLinks($enlaces){
    ...
    //$clase = ($this->pagina == 1) ? "" : "";
    $html = '<li class="page-item"><a class="page-link" href="?limit=' . $this->limite . '&page=' . ($comienzo) . '">&laquo;</a></li>';

    if ($comienzo < 1) {
      $html .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->limite . '&page=1">1</a></li>';
      $html .= '<li class="page-item"><span>...</span></li>';
    }

    for ($i = $comienzo; $i <= $fin; $i++) {
      $clase = ($this->pagina == $i) ? "active" : "";
      $html .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->limite . '&page=' . $i . '">' . $i . '</a></li>';
    }

    if ($fin < $ultimo) {
      $html .= '<li class="disabled"><span>...</span></li>';
      $html .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->limite . '&page=' . $ultimo . '">' . $ultimo . '</a></li>';
    }


    $clase = ($this->pagina == $fin) ? "disabled" : "enabled";                     // ($fin) --> si queremos ir a la ultima
    $html .= '<li class="page-item"><a class="page-link" href="?limit=' . $this->limite . '&page=' . ($fin) . '">&raquo;</a></li>';
    return $html;
    echo "</ul>";
    echo "</nav>";
  }
